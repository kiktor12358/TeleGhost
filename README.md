...
**TeleGhost** — это современная, анонимная и полностью децентрализованная альтернатива Telegram. Это мощный мессенджер, работающий внутри скрытой сети I2P, который теперь реализован и полноценно работает на **Android**! Он обеспечивает высочайшую степень приватности и надежности, недоступную в обычных мессенджерах, используя сквозное шифрование и скрытые сетевые туннели. Идеальный аналог Telegram для тех, кто ценит абсолютную безопасность и контроль над своими данными.
...
<p align="center">
  <img src="assets/login_screen.png" alt="ПК Вход" width="45%">
  &nbsp;
  <img src="assets/main_screen.png" alt="ПК Главный экран" width="45%">
</p>

### 📱 Скриншоты Android-версии

<p align="center">
  <img src="assets/mobile_main.png" alt="Android Главный экран" width="45%">
  &nbsp;
  <img src="assets/mobile_login.png" alt="Android Экран входа" width="45%">
</p>
...
*   **Android**: Скачайте `teleghost.aar` или `app-release.apk` (если доступен в релизе), установите на свой Android-смартфон и наслаждайтесь безопасным общением.
...
- [**Реализовано**] ~~**Файлы и Фото**: Предварительное сжатие на клиенте и механизм докачки (Resume capability).~~
- [**Реализовано**] ~~**Локальная безопасность**: Шифрование базы данных SQLite ключом из Seed-фразы.~~
...
- [**Реализовано**] ~~**Профили защиты**: Переключение режимов туннелирования (🚀 **Fast**, 🛡️ **Default**, 👻 **Invisible**).~~
- [**Реализовано**] ~~**Мобильная адаптация**: Оптимизация Go-ядра для работы на смартфонах и создание полноценного мобильного клиента.~~
